<template>
  <div class="absolute inset-y-1/3 left-10 w-6/12">
    ...
    <!-- <h1 :class="[isDark ? text-black : text-white]" class="font-extrabold font-serif text-5xl mb-5">Fall - Winter Collection 2021</h1> -->
    <h1 class="font-extrabold font-serif text-5xl text-white mb-5">
      Spring - Summer Collection 2021
    </h1>
    <p class="font-sans text-base text-white mb-5">
