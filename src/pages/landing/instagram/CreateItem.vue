<template>
  ...
  <div class="container max-w-4xl mx-auto mb-12 shadow-md md:w-3/4">
    <div class="space-y-6 bg-white">
      ...
      >
        <h2 class="mx-auto text-2xl text-gray-700">Add Instagram Item</h2>
      </div>
      ...
      <div class="w-full text-center">
        <div
          v-if="imageData"
          class="col-span-3 file-listing inline-block bg-cover bg-center relative cursor-pointer w-96 h-96"
...
export default {
  ...
  methods: {
    ...
    async addItem() {
      ...
      const status = await this.$store.dispatch("instagram/createItem", {
        body: {},
        image: this.image,
      ...
      if (status === 201) {
        ...
        this.displayToast(true, "Item created successfully.");
